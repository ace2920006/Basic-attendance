...
const AUDIT_ACTIONS = {
  ...
  TEACHER_VERIFY_LEAVE: 'TEACHER_VERIFY_LEAVE',
  ADMIN_VERIFY_LEAVE: 'ADMIN_VERIFY_LEAVE',
  DOCUMENT_UPLOADED: 'DOCUMENT_UPLOADED',
  DOCUMENT_MALWARE_FLAGGED: 'DOCUMENT_MALWARE_FLAGGED',
  OFFLINE_ATTENDANCE_SYNC: 'OFFLINE_ATTENDANCE_SYNC'
};
